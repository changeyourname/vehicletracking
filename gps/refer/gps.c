...
void utc_to_beijing(void)
{
	...
	temp1=(GPS_DATA.GPS_date[6]-'0')*10+(GPS_DATA.GPS_date[7]-'0');
	if(temp<16)
	{
		temp=temp+8;
		shi=temp/10;
		ge=temp%10;
		GPS_DATA.GPS_time[0]=shi+'0';
		GPS_DATA.GPS_time[1]=ge+'0';	
	}
	else
	{
		temp=temp+8-24;
		...
		shi=temp/10;
		ge=temp%10;
		GPS_DATA.GPS_date[6]=shi+'0';
		GPS_DATA.GPS_date[7]=ge+'0';	
	}
}
